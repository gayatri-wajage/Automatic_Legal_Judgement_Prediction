...
<body>
	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-sm-12">
				<h1 align="center">Advocate Forgot Password</h1>
			</div>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<img alt="Login Image" src="images/fir.png" style="width: 100%;height: 100%;">
			</div>
			<div class="col-sm-6">

				<form action="AdvForgotPass" method="GET">
					<div class="mb-3 mt-3">
					...
					<div class="mb-3">
						<label for="pwd" class="form-label">Old Password:</label> <input
							type="password" class="form-control" id="password" required
							placeholder="Enter password" name="pass">
					</div>
					<div class="mb-3">
						<label for="pwd" class="form-label">New Password:</label> <input
							type="password" class="form-control" id="password" required
