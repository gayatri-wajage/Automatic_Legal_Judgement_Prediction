...
<body>
	...
	<div class="container mt-5">
		...
		<!-- 	<img alt="Student Login Image" src="images/studentLogin.jpeg" style="width: 100%;height: 100%;"> -->
				...
				<h1 align="center">Add New Head Office Record</h1>
			</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<form action="AddHeadOffice" method="post" name="ureg">
					<table style="width: 50%;" align="center">
						<tr>
							<th>Head Office Name</th>
							<td><input type="text" placeholder="Head Office Name"
								class="form-control" name="office_name" 
								required></td>
						</tr>
						
						<tr>
							<th>Area Name</th>
							<td><input type="text" placeholder="Head Office Area Name"
								class="form-control" name="area_name" onblur="return validEmail()"
								required></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" placeholder="Officer Name"
								class="form-control" name="officer_name" 
								required></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" placeholder="Mobile Number"
								class="form-control" name="mobile" onblur="return Validate()"
								required></td>
						</tr>
						...
						<tr>
							...
							<td><textarea rows="5" cols="30" name="address" class="form-control" required></textarea> </td>
						</tr>
						<tr>
							<th></th>
							<td><button type="submit" class="btn btn-success">Add Head Office</button></td>
						</tr>
