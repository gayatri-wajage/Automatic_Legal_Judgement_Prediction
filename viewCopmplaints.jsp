	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-sm-12" align="right">
				<h1 align="center">View Register Petition Details</h1>
			</div>
		</div>
		<hr />
			<div class="row">
			<div class="col-sm-12" align="center">
				...
				<table class="table table-striped" style="width: 80%">
					...
					PreparedStatement ps1 = con.prepareStatement("SELECT * FROM `complaints_details` where complaint_by='"+c_user+"' ORDER BY id DESC");
					...
					<tr class="techSpecRow">
						...
						<td class="techSpecTD2">Case_<%=id%></td>
						...
						<td class="techSpecTD2"><a href="userViewCopmplaintsInDetails.jsp?id=<%=id %>">View Details</a></td>
					</tr>
					<%
												}
											%>
