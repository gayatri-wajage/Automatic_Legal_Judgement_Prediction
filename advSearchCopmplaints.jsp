...
<body>
	...
	<div class="container-fluid">
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="Advhome.jsp">Home</a></li>
	...
	<div class="container mt-5">
		...
		<div class="row">
			<div class="col-sm-12" align="center">
				<form action="advSearchCopmplaints.jsp" method="post">
		...
		%>
				...
				<table class="table table-striped" style="width: 80%">
					...
					<tr class="techSpecRow">
						...
						<td class="techSpecTD2">FIR_<%=id%></td>
						...
						<td class="techSpecTD2"><a
							href="advViewCopmplaintsInDetails.jsp?id=<%=id%>">View
								Details</a></td>
					</tr>
					<%
							}
